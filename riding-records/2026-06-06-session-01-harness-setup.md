# Riding Record — 2026-06-06 Session 01: Harness 搭建
...
- 拉取了全部 33 条消息，梳理出：
  - 群成员：王鹏粤（创建者）、用户044503、用户782086、用户040002、飞书用户4964TA 等
...
| # | 文件名 | 类型 | 作者 | 核心内容 |
|---|--------|------|------|----------|
| 1 | ARY PRD 提交文档 | docx | 王鹏粤 | 产品需求文档：角色、功能、数据需求、验收标准、风险 |
| 2 | ARY PRD 内部设计 | docx | 王鹏粤 | 内部判断、取舍、方案演进、待讨论清单 |
| 3 | ARY PoC 设计文档 | docx | 王鹏粤 | Demo 页面路径、实验性证明、实现策略、验证方式 |
| 4 | ARY PoC 状态文档 | docx | 王鹏粤 | 当前 PoC 状态、数据边界流程、mock 实现、后续计划 |
